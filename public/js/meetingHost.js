...
class HostMeeting {
 ...
 constructor() {
        ...
        // Initialize meeting name manager
        this.meetingNameManager = new MeetingNameManager(this);
    ...
    async init() {
        ...
        // Initialize meeting name
        await this.meetingNameManager.initializeMeetingName();
  ...
  this.socket.on('joined-meeting', (data) => {
    ...
    // Meeting name updated event
    this.socket.on('meeting-name-updated', (data) => {
      this.meetingNameManager.handleMeetingNameUpdated(data);
    });
...
showMeetingInfo() {
    // Update meeting info using the meeting name manager
    this.meetingNameManager.updateMeetingInfoDisplay();
...
endMeeting() {
    if (confirm('Are you sure you want to end the meeting for everyone?')) {
        // Get final meeting name from meeting name manager
        const finalMeetingName = this.meetingNameManager.getFinalMeetingName();
        
        console.log('Ending meeting with final name:', finalMeetingName);
